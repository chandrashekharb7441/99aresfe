...
export default function UserPlots(props) {
  let plots = props.plotData;
          ...
          <div key={plot.id} className="col-12 col-sm-6 col-md-4 col-lg-3 mb-3 d-flex justify-content-center">
            <div className="card shadow-sm" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text"><strong>Size:</strong> {plot.size}</p>
                ...
                <div className="d-flex justify-content-center gap-2 mt-2">
                  ...
                  {localStorage.getItem("userName") && (
                    <Link to={`/user/plot/${plot.id}`} className="flex-fill">
                  ...
                  <a
                    href={`https://wa.me/${plot.mnumber}?text=${encodeURIComponent(
                      `Hello, I am interested in your plot at ${plot.location} priced at ₹${plot.price}`
                    )}`}
                    target="_blank"
