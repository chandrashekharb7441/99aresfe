...
export default function UserPlotSearch(props) {
    ...
    return (
        ...
        <form onSubmit={handleSubmit(submitForm)}>
                ...
                <input type="text" className="form-control me-3" aria-describedby="errorMessage" placeholder='Plot Location' {...register('location')}/>
