...
export default function UserLandSearch(props) {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(submitForm)}>
            ...
            <input type="text" className="form-control me-3" aria-describedby="errorMessage" placeholder='Land Location' {...register('location')}/>
