...
export default function UserLandHome() {
  ...
  const fetchAllLands= async()=>
    {
        let response = await fetch("https://realestate-vfkm.onrender.com/99acres/lands")
  ...
  const SortBySize = async(size)=>
    {
      let url =  size=="all"?
      `https://realestate-vfkm.onrender.com/99acres/lands`:
      `https://realestate-vfkm.onrender.com/99acres/lands/sort/${size}`
  ...
  const FilterByPrice=async(filteringOrder)=>
    {
      ...
      `https://realestate-vfkm.onrender.com/99acres/lands/filter/asc` : 
      `https://realestate-vfkm.onrender.com/99acres/lands/filter/desc`
