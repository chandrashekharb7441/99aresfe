    ...
    <div className="col-12 col-md-4 d-flex justify-content-center mb-4">
      <div className="card" style={{ width: '18rem' }}>
        ...
        <div className="card-body">
          ...
          <Link className="d-flex justify-content-center" to={'/admin/flat/'}><button type="button" className="btn btn-primary">View</button></Link>
        </div>
      </div>
    </div>
    <div className="col-12 col-md-4 d-flex justify-content-center mb-4">
      <div className="card" style={{ width: '18rem' }}>
        ...
        <div className="card-body">
          ...
          <Link className="d-flex justify-content-center" to={'/admin/plot/'}><button type="button" className="btn btn-primary">View</button></Link>
        </div>
      </div>
    </div>
    <div className="col-12 col-md-4 d-flex justify-content-center mb-4">
      ...
      <div className="card-body">
          ...
          <Link className="d-flex justify-content-center" to={'/admin/land/'}><button type="button" className="btn btn-primary">View</button></Link>
        </div>
      </div>
    </div>
  </div>
